 ...
 */
public class ZipLogs extends Thread {
	...
	public ZipLogs(Configuration conf) {
		this.conf = conf;
		this.tranDate = conf.tranDate;
		this.zipDay = Integer.parseInt(conf.get("export.core.ZipLogs"));
	}
	...
	public void run() {
		...
		String directory = PubFun.replaceDate(
				conf.get("export.core.logsDir.String"), zipsDate);
